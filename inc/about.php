...
<body>
    ...
    <h2 class="text-center">About - Pro Car Rentals  <i class="fa-solid fa-car"></i></h2>
    </div>
    <div class="card-body">
    <p>Welcome to our car rental website! We offer a convenient platform for customers to rent cars from trusted agencies. Our website is easy to use and allows customers to browse and book available cars with just a few clicks.</p>
    <p>As a car rental agency, you can also use our website to list your cars and manage bookings. Simply create an account and add your cars to start renting them out to customers.</p>
    <p>Thank you for choosing our website for all your car rental needs. If you have any questions or feedback, don't hesitate to contact us.</p>
